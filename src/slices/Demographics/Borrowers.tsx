...
type BorrowersCountriesPageProps = {
    activePage?: number;
};
...
const BorrowersCountries = styled.div`
    display: flex;
    position: relative;
    width: 100%;
`;

const BorrowersCountriesPage = styled.div<BorrowersCountriesPageProps>`
...
export const Borrowers = (props: BorrowersProps) => {
    ...
    return (
        <BorrowersCountriesWrapper>
            <Legend />
            <BorrowersCountries>
                {data.map((chartData: any, index: number) => (
                    <BorrowersCountriesPage
