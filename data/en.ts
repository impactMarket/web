export const en = {
    config: {
        ...
        wallets: [
            ...
            { address: '0xC483Cd9FC68e58074d1D82b7a9fFdE948Db6d119', code: 'celo', extendedLabel: 'cUSD (Celo Dollar) or CELO', label: 'Celo' },
            { address: '0x4D93536aa77FE4fDD48DC7f2c228410eC49c233C', code: 'eth', extendedLabel: 'ETH or ERC20 tokens', label: 'ETH / ERC 20' }
        ]
    },
    modals: {
        donate: {
